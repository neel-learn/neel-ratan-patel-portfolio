    ...
    <section id="about" className="secondSection screenpage">
      <div className="about-container">
        <div className="about-left-section">
          ...
          <div className="owner-info">PortFolio Owner</div>
          <div id="about-name">
            <h3>
        ...
        <div className="about-right-section">
          ...
          <h4>
            Hi, I am a Java Full Stack Developer with a strong foundation in
            Core & Advanced Java, Spring, Spring Boot, SQL, HTML, CSS,
            JavaScript, and Bootstrap. Quick learner with good problem-solving
            skills and a passion for coding and web development. Complete
            Ethical Hacking course from DROP Organization.
          </h4>
        </div>
      </div>
    </section>
